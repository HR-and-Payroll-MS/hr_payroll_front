        ...
        <div className="max-w-4/12 dark:bg-slate-800/5 inset-shadow-slate-200/25 shadow-xs inset-shadow-xs bg-white/5 rounded-2xl p-12 flex flex-col justify-center gap-6 flex-1 w-full">
          ...
          <div className='flex flex-col justify-center text-center gap-2'>
            ...
            <p className="dark:text-slate-200 text-lg font-normal text-gray-600">
              We have sent a verification code to email address <span className="font-semibold text-slate-900">pristia@gmail.com</span>.
              <button 
                type="button" 
          ...
          <p className="text-center text-gray-500 text-sm font-medium">
            Didn't receive the code? <button type="button" className="text-slate-900 font-bold hover:underline">Resend</button>
          </p>
