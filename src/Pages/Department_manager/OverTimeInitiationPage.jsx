...
const MOCK_EMPLOYEES = [
  { id: 1, name: 'Alice Thompson', role: 'Software Engineer' },
  { id: 2, name: 'David Miller', role: 'UI Designer' },
  { id: 3, name: 'Sarah Chen', role: 'Product Manager' },
  { id: 4, name: 'James Wilson', role: 'QA Analyst' },
  { id: 5, name: 'Elena Rodriguez', role: 'Backend Dev' },
  { id: 6, name: 'Robert Fox', role: 'DevOps Engineer' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center justify-end space-x-4">
              <button 
                className="px-6 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100"
              >
                Cancel
              </button>
              <button 
                ...
                className={`px-8 py-2 rounded-lg text-sm font-semibold text-white 
                  ${isFormValid ? 'bg-blue-600 hover:bg-blue-700 shadow-md' : 'bg-gray-300 cursor-not-allowed'}`}
              >
                Confirm Overtime
              </button>
            </div>
