...
export default function AnnouncementCard({ announcement, onOpen }) {
  ...
  return (
    <div className="p-4 bg-white shadow rounded hover:bg-slate-50  cursor-pointer" onClick={onOpen}>
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
         ...
         <div className="text-sm text-gray-600 mt-2 line-clamp-2" dangerouslySetInnerHTML={{ __html: body }}/>
