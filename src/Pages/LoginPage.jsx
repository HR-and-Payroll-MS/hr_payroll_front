    ...
    >
      ...
      >
        <div className="flex flex-col justify-center gap-5 flex-1 w-full">
          ...
          <button
            type="submit"
            className="w-full bg-slate-900 text-slate-100 py-3 rounded-md text-sm font-semibold hover:bg-slate-800 transition-all active:scale-[0.98] shadow-lg shadow-slate-200 dark:shadow-none"
          >
            Login to Dashboard
          </button>
