export default function Attendance(){
            ...
            <tr className="justify-evenly  ">
                ...
                <th className=" px-4 py-3">
                    <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold text-gray-500  text-xs">Date</p>
                            <img className="h-5 opacity-25" src="\svg\down-arrow-5-svgrepo-com.svg" alt="" />
                    </div>
                </th>
                <th className=" px-4 py-3">
                    <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold text-gray-500  text-xs">Clock in</p>
                            <img className="h-5 opacity-25" src="\svg\down-arrow-5-svgrepo-com.svg" alt="" />
                    </div>
                </th>
                <th className=" px-4 py-3">
                    <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold text-gray-500  text-xs">Clock inLocation</p>
                            <img className="h-5 opacity-25" src="\svg\down-arrow-5-svgrepo-com.svg" alt="" />
                    </div>
                </th>
                <th className=" px-4 py-3">
                    <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold text-gray-500  text-xs">Clock Out</p>
                            <img className="h-5 opacity-25" src="\svg\down-arrow-5-svgrepo-com.svg" alt="" />
                    </div>
                </th>
                <th className=" px-4 py-3">
                    <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold text-gray-500  text-xs">Clock Out Location</p>
                            <img className="h-5 opacity-25" src="\svg\down-arrow-5-svgrepo-com.svg" alt="" />
                    </div>
                </th>
                <th className=" px-4 py-3">
                    <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold text-gray-500  text-xs">Work Schedule</p>
                            <img className="h-5 opacity-25" src="\svg\down-arrow-5-svgrepo-com.svg" alt="" />
                    </div>
                </th>
                <th className=" px-4 py-3">
                    <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold text-gray-500  text-xs">Logged Time</p>
                            <img className="h-5 opacity-25" src="\svg\down-arrow-5-svgrepo-com.svg" alt="" />
                    </div>
                </th>
                <th className=" px-4 py-3">
                    <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold text-gray-500  text-xs">Paid Time</p>
                            <img className="h-5 opacity-25" src="\svg\down-arrow-5-svgrepo-com.svg" alt="" />
                    </div>
                </th>
                <th className=" px-4 py-3">
                    <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold text-gray-500  text-xs">Default</p>
                            <img className="h-5 opacity-25" src="\svg\down-arrow-5-svgrepo-com.svg" alt="" />
                    </div>
                </th>
    ...
    const table_content=<tbody>
            {
                ...
                <td className="border-b border-gray-100 px-4 py-2 ">01 Mar 2025</td>
                <td className="border-b border-gray-100 px-4 py-2 ">08:00(GMT+7)</td>
                ...
                <td className="border-b border-gray-100 px-4 py-2 ">14:30(GMT+7)</td>
                <td className="border-b border-gray-100 px-4 py-2">
                   <div className="flex w-full justify-between items-center ">
                            <p className="font-semibold">Mexico</p>
                            <img className="h-4 opacity-25" src="\svg\location.svg" alt="" />
                ...
                <td className="border-b border-gray-100 px-4 py-2 ">8hr</td>
                <td className="border-b border-gray-100 px-4 py-2 ">8hr30m</td>
                <td className="border-b border-gray-100 px-4 py-2 ">8hr</td>
                <td className="border-b border-gray-100 px-4 py-2 ">+30m</td>
    ...
    const List= <div id="left" className="flex py-2.5 flex-2 gap-3  justify-between items-center  ">
            ...
            <div className="flex bg-white shadow flex-1 flex-col text-gray-700 border border-gray-100 items-start  justify-start gap-5 px-5 py-4 rounded-md">
    ...
    return  <div className={`dark dark:bg-slate-800 flex flex-col w-full h-full bg-gray-50 `}>
                ...
                <div className="flex flex-1 shadow bg-white flex-col h-full p-4 rounded-md">
                    ...
                    <div className=" flex-1   overflow-y-scroll scrollbar-hidden"><table className="table-auto w-full  border-b border-gray-300 ">
                         {table_header}
                         {table_content}
                        </table></div>
