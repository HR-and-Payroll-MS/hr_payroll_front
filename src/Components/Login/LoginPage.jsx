...
export default function Login() {
  ...
  const formContainer = (
    ...
    >
      <form onSubmit={handleSubmit} className="  flex-1 flex flex-col items-center p-7 " action="">
        <div className=" flex flex-col justify-center  flex-1 w-full ">
          ...
          <button type="submit" className="items-center justify-center bg-gray-100 inline-flex px-32 py-2.5 rounded-md text-sm font-semibold text-gray-500">
            Login
          </button>
  ...
  return (
    <div
      className={`${darklight.Magic_Word}  flex-1 py-5 px-48 h-screen dark:bg-slate-800 bg-slate-100 w-full flex justify-center`}
    >
