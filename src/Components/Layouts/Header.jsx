export default function Header(){
        ...
        <div id="middle" className="flex w-3/5 justify-start gap-7 items-center ">
                <p className={`font-semibold text-gray-700  text-sm  dark:font-slate-300 dark:text-slate-300 `}>Documents</p>
                <p className={`font-semibold text-gray-700  text-sm  dark:font-slate-300 dark:text-slate-300 `}>News</p>
                <p className={`font-semibold text-gray-700  text-sm  dark:font-slate-300 dark:text-slate-300 `}>Payslip</p>
                <p className={`font-semibold text-gray-700  text-sm  dark:font-slate-300 dark:text-slate-300 `}>Report</p>
        </div>
