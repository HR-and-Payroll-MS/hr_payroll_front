...
import { RenderFields } from "./RenderFields";
  ...
  export const RenderStepContent = ({handleInputChange,handleSave,handleCancel,handleEditToggle,editMode=[],employeeData=[],currentStep,fileDelete}) => {
    switch (currentStep) {
      case 0:
        return (
      ...
      case 3:
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-2"><DocumentList files={employeeData.documents.files} isEditing={editMode} fileDelete={fileDelete} /></div>
          </div>
        );
      default:
        return null;
