  ...
  return (
    ...
    <div className="flex  flex-1 gap-5 overflow-y-scroll rounded-md h-full">
        ...
        <div className="flex  flex-col rounded-md shadow h-full flex-1 gap-4  p-4 bg-white">
            ...
            />
            <div className=" flex-1  overflow-y-auto"><RenderStepContent handleInputChange={handleInputChange} handleSave={handleSave} handleEditToggle={handleEditToggle} editMode={editMode} employeeData={employeeData} currentStep={currentStep} fileDelete={fileDelete}/></div>
...
export {Checkup ,Checkup2,Checkup3,Checkup4} 